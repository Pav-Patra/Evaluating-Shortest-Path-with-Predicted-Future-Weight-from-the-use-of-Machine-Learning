...
class Graph:
    ...
    def generateGraph(self):
        ...
        # 40 represents the maximum number of nodes in the graph 
        # this graph will ensure the graph contains double the number of edges than nodes

        totalNodes = 300        # add each of these stated totalNodes to the graph, starting from zero
...
# algorithm to change the shortest path trees for each node when an edge changes weight
